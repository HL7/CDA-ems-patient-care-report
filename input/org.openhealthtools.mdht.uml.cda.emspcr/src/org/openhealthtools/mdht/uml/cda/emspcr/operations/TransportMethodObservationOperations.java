...
public class TransportMethodObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TRANSPORT_METHOD_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.34' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"TransportMethodObservationTransportMethodObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"TransportMethodObservationTransportMethodObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"TransportMethodObservationTransportMethodObservationCodeP","ERROR");
...
"value.code = '67549-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"TransportMethodObservationTransportMethodObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17168-8' or value.code = 'LA17169-6' or value.code = 'LA17170-4' or value.code = 'LA17171-2' or value.code = 'LA17172-0' or value.code = 'LA17173-8' or value.code = 'LA17174-6' or value.code = 'LA17175-3' or value.code = 'LA17176-1')))";
    ...
    DatatypesUtil.increment(context,"TransportMethodObservationTransportMethodObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"TransportMethodObservationTransportMethodObservationValueP","ERROR");
