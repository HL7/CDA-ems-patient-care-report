...
public class FirstUnitIndicatorOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_FIRST_UNIT_INDICATOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.84' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"FirstUnitIndicatorFirstUnitIndicatorTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"FirstUnitIndicatorFirstUnitIndicatorMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"FirstUnitIndicatorFirstUnitIndicatorCodeP","ERROR");
...
"value.code = '67481-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"FirstUnitIndicatorFirstUnitIndicatorCode","ERROR");
    ...
    DatatypesUtil.increment(context,"FirstUnitIndicatorFirstUnitIndicatorValue","ERROR");
