...
public class ProcedureNumberOfAttemptsObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURE_NUMBER_OF_ATTEMPTS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.132' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ProcedureNumberOfAttemptsObservationProcedureNumberOfAttemptsObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedureNumberOfAttemptsObservationProcedureNumberOfAttemptsObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedureNumberOfAttemptsObservationProcedureNumberOfAttemptsObservationCodeP","ERROR");
...
"value.code = '67543-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ProcedureNumberOfAttemptsObservationProcedureNumberOfAttemptsObservationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedureNumberOfAttemptsObservationProcedureNumberOfAttemptsObservationValue","ERROR");
