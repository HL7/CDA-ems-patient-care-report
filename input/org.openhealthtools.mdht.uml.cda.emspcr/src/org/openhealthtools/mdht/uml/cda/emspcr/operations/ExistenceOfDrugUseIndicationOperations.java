...
public class ExistenceOfDrugUseIndicationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EXISTENCE_OF_DRUG_USE_INDICATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.70' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ExistenceOfDrugUseIndicationExistenceOfDrugUseIndicationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ExistenceOfDrugUseIndicationExistenceOfDrugUseIndicationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ExistenceOfDrugUseIndicationExistenceOfDrugUseIndicationCodeP","ERROR");
...
"value.code = '69757-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ExistenceOfDrugUseIndicationExistenceOfDrugUseIndicationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ExistenceOfDrugUseIndicationExistenceOfDrugUseIndicationValue","ERROR");
