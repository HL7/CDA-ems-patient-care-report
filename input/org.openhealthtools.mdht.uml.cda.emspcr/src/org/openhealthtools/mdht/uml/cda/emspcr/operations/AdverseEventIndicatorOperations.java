...
public class AdverseEventIndicatorOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_ADVERSE_EVENT_INDICATOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.89' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"AdverseEventIndicatorAdverseEventIndicatorTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"AdverseEventIndicatorAdverseEventIndicatorMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"AdverseEventIndicatorAdverseEventIndicatorCodeP","ERROR");
...
"value.code = '67554-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"AdverseEventIndicatorAdverseEventIndicatorCode","ERROR");
    ...
    DatatypesUtil.increment(context,"AdverseEventIndicatorAdverseEventIndicatorValue","ERROR");
