...
public class EMSSituationSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SITUATION_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.9' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionTemplateId","ERROR");
...
"value.code = '67666-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionCode","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionCodeP","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionTitle","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionText","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionComplaint","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionPossibleInjury","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SITUATION_SECTION_PROVIDER_PRIMARY_IMPRESSION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::ProviderPrimaryImpression) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionProviderPrimaryImpression","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SITUATION_SECTION_PRIMARY_SYMPTOM__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::PrimarySymptom) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionPrimarySymptom","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SITUATION_SECTION_OTHER_SYMPTOMS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::OtherSymptoms) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionOtherSymptoms","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SITUATION_SECTION_PROVIDER_SECONDARY_IMPRESSIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::ProviderSecondaryImpressions) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionProviderSecondaryImpressions","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SITUATION_SECTION_INITIAL_PATIENT_ACUITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::InitialPatientAcuity) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSSituationSectionEMSSituationSectionInitialPatientAcuity","ERROR");
	...
	public static ProviderSecondaryImpressions getProviderSecondaryImpressions(
			EMSSituationSection emsSituationSection) {
