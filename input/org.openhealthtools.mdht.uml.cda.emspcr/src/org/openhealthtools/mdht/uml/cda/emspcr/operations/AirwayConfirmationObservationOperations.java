...
public class AirwayConfirmationObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_AIRWAY_CONFIRMATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.175' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationCodeP","ERROR");
...
"value.code = '71576-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationEffectiveTime","ERROR");
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationValue","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_AIRWAY_CONFIRMATION_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.methodCode->isEmpty() or self.methodCode->exists(element | element.isNullFlavorUndefined())) implies (not self.methodCode->isEmpty())";
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationMethodCodeP","INFO");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_AIRWAY_CONFIRMATION_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(airwayConfirmationObservation)) {
			...
			if (context != null) {
				// generate a pass token for my dependent constraints to short-circuit or filter results
				@SuppressWarnings("unchecked")
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.emspcr.AirwayConfirmationObservationMethodCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.emspcr.AirwayConfirmationObservationMethodCodeP", passToken);
				}
				passToken.add(airwayConfirmationObservation);
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA18672-8' or value.code = 'LA18673-6' or value.code = 'LA18674-4' or value.code = 'LA18675-1' or value.code = 'LA18676-9' or value.code = 'LA18677-7' or value.code = 'LA18678-5' or value.code = 'LA18680-1' or value.code = 'LA18681-9' or value.code = 'LA18679-3' or value.code = 'LA32909-6')))";
	...
	public static boolean validateAirwayConfirmationObservationMethodCode(
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.AirwayConfirmationObservationMethodCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(airwayConfirmationObservation)) {
			// I have a free pass to short-circuit
			return true;
		}
    ...
    DatatypesUtil.increment(context,"AirwayConfirmationObservationAirwayConfirmationObservationMethodCode","ERROR");
