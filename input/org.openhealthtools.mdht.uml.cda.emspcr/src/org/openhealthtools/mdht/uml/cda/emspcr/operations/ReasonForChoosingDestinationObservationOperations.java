...
public class ReasonForChoosingDestinationObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_REASON_FOR_CHOOSING_DESTINATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.35' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationCodeP","ERROR");
...
"value.code = '67552-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17059-9' or value.code = 'LA17182-9' or value.code = 'LA17184-5' or value.code = 'LA17185-2' or value.code = 'LA17186-0' or value.code = 'LA17187-8' or value.code = 'LA17188-6' or value.code = 'LA17189-4' or value.code = 'LA17190-2' or value.code = 'LA17191-0' or value.code = 'LA18301-4')))";
    ...
    DatatypesUtil.increment(context,"ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationValueP","ERROR");
