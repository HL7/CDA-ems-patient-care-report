...
public class PatientCareReportOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_GENERAL_HEADER_CONSTRAINTS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.2' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"PatientCareReportGeneralHeaderConstraintsTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportGeneralHeaderConstraintsId","ERROR");
...
"value.code = '67796-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"PatientCareReportGeneralHeaderConstraintsTitle","ERROR");
...
"value.code = 'N')";
    ...
    DatatypesUtil.increment(context,"PatientCareReportGeneralHeaderConstraintsVersionNumber","INFO");
    ...
    DatatypesUtil.increment(context,"PatientCareReportGeneralHeaderConstraintsComponentOf","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportGeneralHeaderConstraintsCustodian","ERROR");
