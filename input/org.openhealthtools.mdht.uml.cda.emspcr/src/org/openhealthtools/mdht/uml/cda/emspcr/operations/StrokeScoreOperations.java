...
public class StrokeScoreOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_STROKE_SCORE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.163' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreCodeP","ERROR");
...
"value.code = '67520-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreCode","ERROR");
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreEffectiveTime","INFO");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17109-2' or value.code = 'LA6576-8' or value.code = 'LA6577-6')))";
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreValue","ERROR");
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreValueP","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17110-0' or value.code = 'LA17112-6' or value.code = 'LA17113-4' or value.code = 'LA18300-6' or value.code = 'LA3774-2' or value.code = 'LA24430-3' or value.code = 'LA33001-1' or value.code = 'LA33000-3' or value.code = 'LA32999-7' or value.code = 'LA32998-9' or value.code = 'LA32997-1' or value.code = 'LA33002-9')))";
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreMethodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"StrokeScoreStrokeScoreMethodCodeP","ERROR");
