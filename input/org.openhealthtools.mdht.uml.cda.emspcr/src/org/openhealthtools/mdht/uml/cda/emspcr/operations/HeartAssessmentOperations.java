...
public class HeartAssessmentOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_HEART_ASSESSMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.116' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentCodeP","ERROR");
...
"value.code = '67529-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentCode","ERROR");
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentEffectiveTime","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17239-7' or value.code = 'LA17240-5' or value.code = 'LA17241-3' or value.code = 'LA18241-2' or value.code = 'LA18242-0' or value.code = 'LA18243-8' or value.code = 'LA18244-6' or value.code = 'LA18245-3' or value.code = 'LA18246-1' or value.code = 'LA6626-1')))";
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentValue","ERROR");
    ...
    DatatypesUtil.increment(context,"HeartAssessmentHeartAssessmentValueP","ERROR");
