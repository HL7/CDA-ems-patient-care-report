...
public class MedicationPriorAdministrationObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MEDICATION_PRIOR_ADMINISTRATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.108' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"MedicationPriorAdministrationObservationMedicationPriorAdministrationObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationPriorAdministrationObservationMedicationPriorAdministrationObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationPriorAdministrationObservationMedicationPriorAdministrationObservationCodeP","ERROR");
...
"value.code = '67539-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"MedicationPriorAdministrationObservationMedicationPriorAdministrationObservationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationPriorAdministrationObservationMedicationPriorAdministrationObservationValue","ERROR");
