...
public class BillingConditionOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BILLING_CONDITION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.91' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"BillingConditionBillingConditionTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"BillingConditionBillingConditionCodeP","ERROR");
...
"value.code = '67556-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"BillingConditionBillingConditionCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.90'))";
    ...
    DatatypesUtil.increment(context,"BillingConditionBillingConditionValue","ERROR");
	...
	public static boolean validateBillingConditionValueP(BillingCondition billingCondition, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"BillingConditionBillingConditionValueP","ERROR");
    ...
    DatatypesUtil.increment(context,"BillingConditionBillingConditionMoodCode","ERROR");
