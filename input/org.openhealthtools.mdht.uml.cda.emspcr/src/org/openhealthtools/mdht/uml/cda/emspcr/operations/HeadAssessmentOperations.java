...
public class HeadAssessmentOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_HEAD_ASSESSMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.113' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"HeadAssessmentHeadAssessmentTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"HeadAssessmentHeadAssessmentMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"HeadAssessmentHeadAssessmentCodeP","ERROR");
...
"value.code = '67525-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"HeadAssessmentHeadAssessmentCode","ERROR");
    ...
    DatatypesUtil.increment(context,"HeadAssessmentHeadAssessmentEffectiveTime","WARNING");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17208-2' or value.code = 'LA17209-0' or value.code = 'LA17210-8' or value.code = 'LA17211-6' or value.code = 'LA17213-2' or value.code = 'LA17214-0' or value.code = 'LA17212-4' or value.code = 'LA18220-6' or value.code = 'LA18221-4' or value.code = 'LA18222-2' or value.code = 'LA18223-0' or value.code = 'LA18224-8' or value.code = 'LA18225-5' or value.code = 'LA18226-3' or value.code = 'LA6626-1' or value.code = 'LA7410-9' or value.code = 'LA7452-1' or value.code = 'LA7460-4' or value.code = 'LA7423-2' or value.code = 'LA17229-8' or value.code = 'LA22440-4' or value.code = 'LA17709-9')))";
    ...
    DatatypesUtil.increment(context,"HeadAssessmentHeadAssessmentValue","ERROR");
