 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='TransportModeQualifierTemplateId TransportModeQualifierClassCode TransportModeQualifierCode TransportModeQualifierCodeP TransportModeQualifierMoodCode TransportModeQualifierValue TransportModeQualifierValueP' templateId.root='2.16.840.1.1133883.17.3.10.1.193' templateId.extension='2022-01-01' classCode='OBS' code.code='77153-5' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Transport Mode Descriptors' constraints.validation.dependOn.TransportModeQualifierCode='TransportModeQualifierCodeP' moodCode='EVN' value.codeSystem='2.16.840.1.113883.6.1' value.codeSystemName='LOINC'"
 * @generated
 */
public interface TransportModeQualifier extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId-&gt;exists(id : datatypes::II | id.root = \'2.16.840.1.1133883.17.3.10.1.193\' and id.extension = \'2022-01-01\')'"
	 * @generated
	 */
	 ...
	 * @generated
	 */
	boolean validateTransportModeQualifierValueP(DiagnosticChain diagnostics, Map<Object, Object> context);
