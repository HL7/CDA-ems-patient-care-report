...
public class ResponseEndingOdometerReadingOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_RESPONSE_ENDING_ODOMETER_READING_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.174' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ResponseEndingOdometerReadingResponseEndingOdometerReadingTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseEndingOdometerReadingResponseEndingOdometerReadingMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseEndingOdometerReadingResponseEndingOdometerReadingCodeP","ERROR");
...
"value.code = '67487-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ResponseEndingOdometerReadingResponseEndingOdometerReadingCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseEndingOdometerReadingResponseEndingOdometerReadingValue","ERROR");
