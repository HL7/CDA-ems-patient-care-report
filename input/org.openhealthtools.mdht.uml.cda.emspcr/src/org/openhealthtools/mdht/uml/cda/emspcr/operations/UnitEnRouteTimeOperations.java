...
public class UnitEnRouteTimeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_UNIT_EN_ROUTE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.40' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"UnitEnRouteTimeUnitEnRouteTimeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitEnRouteTimeUnitEnRouteTimeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitEnRouteTimeUnitEnRouteTimeCodeP","ERROR");
...
"value.code = '69472-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"UnitEnRouteTimeUnitEnRouteTimeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitEnRouteTimeUnitEnRouteTimeValue","ERROR");
