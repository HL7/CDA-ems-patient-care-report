...
public class ResponseBeginningOdometerReadingOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_RESPONSE_BEGINNING_ODOMETER_READING_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.171' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ResponseBeginningOdometerReadingResponseBeginningOdometerReadingTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseBeginningOdometerReadingResponseBeginningOdometerReadingMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseBeginningOdometerReadingResponseBeginningOdometerReadingCodeP","ERROR");
...
"value.code = '67484-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ResponseBeginningOdometerReadingResponseBeginningOdometerReadingCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseBeginningOdometerReadingResponseBeginningOdometerReadingValue","ERROR");
