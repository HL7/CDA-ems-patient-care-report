...
public class BloodGlucoseTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateBloodGlucoseCodeP() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return BloodGlucoseOperations.validateBloodGlucoseCodeP(
					(BloodGlucose) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateBloodGlucoseCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_BLOOD_GLUCOSE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return BloodGlucoseOperations.validateBloodGlucoseCode(
					(BloodGlucose) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateBloodGlucoseValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_BLOOD_GLUCOSE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return BloodGlucoseOperations.validateBloodGlucoseValue(
					(BloodGlucose) objectToTest, diagnostician, map);
			}
