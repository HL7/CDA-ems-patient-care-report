...
public void testValidateMedicationNotAdministeredReasonObservationCodeP() {
			OperationsTestCase<MedicationNotAdministeredReasonObservation> validateMedicationNotAdministeredReasonObservationCodePTestCase = new OperationsTestCase<MedicationNotAdministeredReasonObservation>(
			"validateMedicationNotAdministeredReasonObservationCodeP",
			operationsForOCL.getOCLValue("VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return MedicationNotAdministeredReasonObservationOperations.validateMedicationNotAdministeredReasonObservationCodeP(
					(MedicationNotAdministeredReasonObservation) objectToTest, diagnostician, map);
			}

		};

		validateMedicationNotAdministeredReasonObservationCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateMedicationNotAdministeredReasonObservationCode() {
        ...
        @Override
            protected void setDependency(MedicationNotAdministeredReasonObservation target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.MedicationNotAdministeredReasonObservationCodeP", passToken);
            }
