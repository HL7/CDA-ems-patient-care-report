...
public void testValidateEMSInjuryIncidentDescriptionSectionCodeP() {
			OperationsTestCase<EMSInjuryIncidentDescriptionSection> validateEMSInjuryIncidentDescriptionSectionCodePTestCase = new OperationsTestCase<EMSInjuryIncidentDescriptionSection>(
			"validateEMSInjuryIncidentDescriptionSectionCodeP",
			operationsForOCL.getOCLValue("VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EMSInjuryIncidentDescriptionSectionOperations.validateEMSInjuryIncidentDescriptionSectionCodeP(
					(EMSInjuryIncidentDescriptionSection) objectToTest, diagnostician, map);
			}

		};

		validateEMSInjuryIncidentDescriptionSectionCodePTestCase.doValidationTest();
}
