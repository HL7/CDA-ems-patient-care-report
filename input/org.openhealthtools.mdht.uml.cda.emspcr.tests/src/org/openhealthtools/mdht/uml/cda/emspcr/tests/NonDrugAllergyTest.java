...
public void testValidateNonDrugAllergyCodeP() {
			OperationsTestCase<NonDrugAllergy> validateNonDrugAllergyCodePTestCase = new OperationsTestCase<NonDrugAllergy>(
			"validateNonDrugAllergyCodeP",
			operationsForOCL.getOCLValue("VALIDATE_NON_DRUG_ALLERGY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return NonDrugAllergyOperations.validateNonDrugAllergyCodeP(
					(NonDrugAllergy) objectToTest, diagnostician, map);
			}

		};

		validateNonDrugAllergyCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateNonDrugAllergyCode() {
        ...
        @Override
            protected void setDependency(NonDrugAllergy target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.NonDrugAllergyCodeP", passToken);
            }
...
public void testValidateNonDrugAllergyValueP() {
			OperationsTestCase<NonDrugAllergy> validateNonDrugAllergyValuePTestCase = new OperationsTestCase<NonDrugAllergy>(
			"validateNonDrugAllergyValueP",
			operationsForOCL.getOCLValue("VALIDATE_NON_DRUG_ALLERGY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return NonDrugAllergyOperations.validateNonDrugAllergyValueP(
					(NonDrugAllergy) objectToTest, diagnostician, map);
			}

		};

		validateNonDrugAllergyValuePTestCase.doValidationTest();
}
