...
public class PatientAgeTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidatePatientAgeTemplateId() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PatientAgeOperations.validatePatientAgeTemplateId(
					(PatientAge) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidatePatientAgeMoodCode() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PatientAgeOperations.validatePatientAgeMoodCode(
					(PatientAge) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidatePatientAgeCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PATIENT_AGE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PatientAgeOperations.validatePatientAgeCodeP(
					(PatientAge) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidatePatientAgeCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PATIENT_AGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PatientAgeOperations.validatePatientAgeCode(
					(PatientAge) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidatePatientAgeValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PATIENT_AGE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PatientAgeOperations.validatePatientAgeValue(
					(PatientAge) objectToTest, diagnostician, map);
			}
