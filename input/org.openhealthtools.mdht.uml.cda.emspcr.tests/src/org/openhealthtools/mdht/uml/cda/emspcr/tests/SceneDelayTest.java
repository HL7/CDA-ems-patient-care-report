...
public class SceneDelayTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateSceneDelayTemplateId() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SceneDelayOperations.validateSceneDelayTemplateId(
					(SceneDelay) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateSceneDelayMoodCode() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SceneDelayOperations.validateSceneDelayMoodCode(
					(SceneDelay) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateSceneDelayCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_SCENE_DELAY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SceneDelayOperations.validateSceneDelayCodeP(
					(SceneDelay) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateSceneDelayCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_SCENE_DELAY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SceneDelayOperations.validateSceneDelayCode(
					(SceneDelay) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateSceneDelayValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_SCENE_DELAY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SceneDelayOperations.validateSceneDelayValue(
					(SceneDelay) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateSceneDelayValueP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_SCENE_DELAY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return SceneDelayOperations.validateSceneDelayValueP(
					(SceneDelay) objectToTest, diagnostician, map);
			}
