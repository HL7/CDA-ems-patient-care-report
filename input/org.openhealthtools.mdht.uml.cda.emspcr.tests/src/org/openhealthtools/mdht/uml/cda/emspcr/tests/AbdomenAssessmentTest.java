...
public void testValidateAbdomenAssessmentValueP() {
			OperationsTestCase<AbdomenAssessment> validateAbdomenAssessmentValuePTestCase = new OperationsTestCase<AbdomenAssessment>(
			"validateAbdomenAssessmentValueP",
			operationsForOCL.getOCLValue("VALIDATE_ABDOMEN_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return AbdomenAssessmentOperations.validateAbdomenAssessmentValueP(
					(AbdomenAssessment) objectToTest, diagnostician, map);
			}

		};

		validateAbdomenAssessmentValuePTestCase.doValidationTest();
}
...
public void testValidateAbdomenAssessmentTargetSiteCodeP() {
			OperationsTestCase<AbdomenAssessment> validateAbdomenAssessmentTargetSiteCodePTestCase = new OperationsTestCase<AbdomenAssessment>(
			"validateAbdomenAssessmentTargetSiteCodeP",
			operationsForOCL.getOCLValue("VALIDATE_ABDOMEN_ASSESSMENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return AbdomenAssessmentOperations.validateAbdomenAssessmentTargetSiteCodeP(
					(AbdomenAssessment) objectToTest, diagnostician, map);
			}

		};

		validateAbdomenAssessmentTargetSiteCodePTestCase.doValidationTest();
}
