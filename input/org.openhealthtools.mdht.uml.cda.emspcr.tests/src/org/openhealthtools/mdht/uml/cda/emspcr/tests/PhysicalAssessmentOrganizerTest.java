...
public void testValidatePhysicalAssessmentOrganizerComponent412() {
			OperationsTestCase<PhysicalAssessmentOrganizer> validatePhysicalAssessmentOrganizerComponent412TestCase = new OperationsTestCase<PhysicalAssessmentOrganizer>(
			"validatePhysicalAssessmentOrganizerComponent412",
			operationsForOCL.getOCLValue("VALIDATE_PHYSICAL_ASSESSMENT_ORGANIZER_COMPONENT412__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PhysicalAssessmentOrganizerOperations.validatePhysicalAssessmentOrganizerComponent412(
					(PhysicalAssessmentOrganizer) objectToTest, diagnostician, map);
			}

		};

		validatePhysicalAssessmentOrganizerComponent412TestCase.doValidationTest();
}
...
public void testValidatePhysicalAssessmentOrganizerComponent15() {
			OperationsTestCase<PhysicalAssessmentOrganizer> validatePhysicalAssessmentOrganizerComponent15TestCase = new OperationsTestCase<PhysicalAssessmentOrganizer>(
			"validatePhysicalAssessmentOrganizerComponent15",
			operationsForOCL.getOCLValue("VALIDATE_PHYSICAL_ASSESSMENT_ORGANIZER_COMPONENT15__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PhysicalAssessmentOrganizerOperations.validatePhysicalAssessmentOrganizerComponent15(
					(PhysicalAssessmentOrganizer) objectToTest, diagnostician, map);
			}

		};

		validatePhysicalAssessmentOrganizerComponent15TestCase.doValidationTest();
}
...
public void testValidatePhysicalAssessmentOrganizerComponent42() {
			OperationsTestCase<PhysicalAssessmentOrganizer> validatePhysicalAssessmentOrganizerComponent42TestCase = new OperationsTestCase<PhysicalAssessmentOrganizer>(
			"validatePhysicalAssessmentOrganizerComponent42",
			operationsForOCL.getOCLValue("VALIDATE_PHYSICAL_ASSESSMENT_ORGANIZER_COMPONENT42__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PhysicalAssessmentOrganizerOperations.validatePhysicalAssessmentOrganizerComponent42(
					(PhysicalAssessmentOrganizer) objectToTest, diagnostician, map);
			}

		};

		validatePhysicalAssessmentOrganizerComponent42TestCase.doValidationTest();
}
...
public void testValidatePhysicalAssessmentOrganizerComponent413() {
			OperationsTestCase<PhysicalAssessmentOrganizer> validatePhysicalAssessmentOrganizerComponent413TestCase = new OperationsTestCase<PhysicalAssessmentOrganizer>(
			"validatePhysicalAssessmentOrganizerComponent413",
			operationsForOCL.getOCLValue("VALIDATE_PHYSICAL_ASSESSMENT_ORGANIZER_COMPONENT413__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PhysicalAssessmentOrganizerOperations.validatePhysicalAssessmentOrganizerComponent413(
					(PhysicalAssessmentOrganizer) objectToTest, diagnostician, map);
			}

		};

		validatePhysicalAssessmentOrganizerComponent413TestCase.doValidationTest();
}
