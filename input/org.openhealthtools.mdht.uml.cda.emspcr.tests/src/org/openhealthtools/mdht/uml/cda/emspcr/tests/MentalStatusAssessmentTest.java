...
public void testValidateMentalStatusAssessmentEffectiveTime() {
			OperationsTestCase<MentalStatusAssessment> validateMentalStatusAssessmentEffectiveTimeTestCase = new OperationsTestCase<MentalStatusAssessment>(
			"validateMentalStatusAssessmentEffectiveTime",
			operationsForOCL.getOCLValue("VALIDATE_MENTAL_STATUS_ASSESSMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return MentalStatusAssessmentOperations.validateMentalStatusAssessmentEffectiveTime(
					(MentalStatusAssessment) objectToTest, diagnostician, map);
			}

		};

		validateMentalStatusAssessmentEffectiveTimeTestCase.doValidationTest();
}
...
public void testValidateMentalStatusAssessmentValueP() {
			OperationsTestCase<MentalStatusAssessment> validateMentalStatusAssessmentValuePTestCase = new OperationsTestCase<MentalStatusAssessment>(
			"validateMentalStatusAssessmentValueP",
			operationsForOCL.getOCLValue("VALIDATE_MENTAL_STATUS_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return MentalStatusAssessmentOperations.validateMentalStatusAssessmentValueP(
					(MentalStatusAssessment) objectToTest, diagnostician, map);
			}

		};

		validateMentalStatusAssessmentValuePTestCase.doValidationTest();
}
