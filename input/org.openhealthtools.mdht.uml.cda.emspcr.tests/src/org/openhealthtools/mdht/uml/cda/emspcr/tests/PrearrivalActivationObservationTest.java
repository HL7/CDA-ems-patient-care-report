...
public void testValidatePrearrivalActivationObservationValueP() {
			OperationsTestCase<PrearrivalActivationObservation> validatePrearrivalActivationObservationValuePTestCase = new OperationsTestCase<PrearrivalActivationObservation>(
			"validatePrearrivalActivationObservationValueP",
			operationsForOCL.getOCLValue("VALIDATE_PREARRIVAL_ACTIVATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PrearrivalActivationObservationOperations.validatePrearrivalActivationObservationValueP(
					(PrearrivalActivationObservation) objectToTest, diagnostician, map);
			}

		};

		validatePrearrivalActivationObservationValuePTestCase.doValidationTest();
}
