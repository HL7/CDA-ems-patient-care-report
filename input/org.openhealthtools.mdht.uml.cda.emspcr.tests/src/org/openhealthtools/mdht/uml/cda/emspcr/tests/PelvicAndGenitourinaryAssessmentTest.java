...
public void testValidatePelvicAndGenitourinaryAssessmentCodeP() {
			OperationsTestCase<PelvicAndGenitourinaryAssessment> validatePelvicAndGenitourinaryAssessmentCodePTestCase = new OperationsTestCase<PelvicAndGenitourinaryAssessment>(
			"validatePelvicAndGenitourinaryAssessmentCodeP",
			operationsForOCL.getOCLValue("VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PelvicAndGenitourinaryAssessmentOperations.validatePelvicAndGenitourinaryAssessmentCodeP(
					(PelvicAndGenitourinaryAssessment) objectToTest, diagnostician, map);
			}

		};

		validatePelvicAndGenitourinaryAssessmentCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidatePelvicAndGenitourinaryAssessmentCode() {
        ...
        @Override
            protected void setDependency(PelvicAndGenitourinaryAssessment target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.PelvicAndGenitourinaryAssessmentCodeP", passToken);
            }
