...
public void testValidateProcedureComplicationsObservationValueP() {
			OperationsTestCase<ProcedureComplicationsObservation> validateProcedureComplicationsObservationValuePTestCase = new OperationsTestCase<ProcedureComplicationsObservation>(
			"validateProcedureComplicationsObservationValueP",
			operationsForOCL.getOCLValue("VALIDATE_PROCEDURE_COMPLICATIONS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ProcedureComplicationsObservationOperations.validateProcedureComplicationsObservationValueP(
					(ProcedureComplicationsObservation) objectToTest, diagnostician, map);
			}

		};

		validateProcedureComplicationsObservationValuePTestCase.doValidationTest();
}
