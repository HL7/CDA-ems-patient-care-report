...
public class DisasterTypeTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateDisasterTypeCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_DISASTER_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return DisasterTypeOperations.validateDisasterTypeCode(
					(DisasterType) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateDisasterTypeValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_DISASTER_TYPE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return DisasterTypeOperations.validateDisasterTypeValue(
					(DisasterType) objectToTest, diagnostician, map);
			}
...
public void testValidateDisasterTypeValueP() {
			OperationsTestCase<DisasterType> validateDisasterTypeValuePTestCase = new OperationsTestCase<DisasterType>(
			"validateDisasterTypeValueP",
			operationsForOCL.getOCLValue("VALIDATE_DISASTER_TYPE_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return DisasterTypeOperations.validateDisasterTypeValueP(
					(DisasterType) objectToTest, diagnostician, map);
			}

		};

		validateDisasterTypeValuePTestCase.doValidationTest();
}
