...
public class GlasgowEyeTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateGlasgowEyeTemplateId() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowEyeOperations.validateGlasgowEyeTemplateId(
					(GlasgowEye) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowEyeMoodCode() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowEyeOperations.validateGlasgowEyeMoodCode(
					(GlasgowEye) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowEyeCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_EYE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowEyeOperations.validateGlasgowEyeCodeP(
					(GlasgowEye) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowEyeCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_EYE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowEyeOperations.validateGlasgowEyeCode(
					(GlasgowEye) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowEyeValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_EYE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowEyeOperations.validateGlasgowEyeValue(
					(GlasgowEye) objectToTest, diagnostician, map);
			}
