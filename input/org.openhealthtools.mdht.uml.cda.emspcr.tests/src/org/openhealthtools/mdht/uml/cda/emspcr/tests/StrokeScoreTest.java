...
public class StrokeScoreTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateStrokeScoreMoodCode() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return StrokeScoreOperations.validateStrokeScoreMoodCode(
					(StrokeScore) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateStrokeScoreCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_STROKE_SCORE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return StrokeScoreOperations.validateStrokeScoreCodeP(
					(StrokeScore) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateStrokeScoreCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_STROKE_SCORE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return StrokeScoreOperations.validateStrokeScoreCode(
					(StrokeScore) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateStrokeScoreValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_STROKE_SCORE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return StrokeScoreOperations.validateStrokeScoreValue(
					(StrokeScore) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateStrokeScoreValueP() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return StrokeScoreOperations.validateStrokeScoreValueP(
					(StrokeScore) objectToTest, diagnostician, map);
			}
