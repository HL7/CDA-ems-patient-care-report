...
public void testValidateEMSAllergiesAndAdverseReactionsSectionCodeP() {
			OperationsTestCase<EMSAllergiesAndAdverseReactionsSection> validateEMSAllergiesAndAdverseReactionsSectionCodePTestCase = new OperationsTestCase<EMSAllergiesAndAdverseReactionsSection>(
			"validateEMSAllergiesAndAdverseReactionsSectionCodeP",
			operationsForOCL.getOCLValue("VALIDATE_EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EMSAllergiesAndAdverseReactionsSectionOperations.validateEMSAllergiesAndAdverseReactionsSectionCodeP(
					(EMSAllergiesAndAdverseReactionsSection) objectToTest, diagnostician, map);
			}

		};

		validateEMSAllergiesAndAdverseReactionsSectionCodePTestCase.doValidationTest();
}
