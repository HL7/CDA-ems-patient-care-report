...
public void testValidateThrombolyticContraindicationsValueP() {
			OperationsTestCase<ThrombolyticContraindications> validateThrombolyticContraindicationsValuePTestCase = new OperationsTestCase<ThrombolyticContraindications>(
			"validateThrombolyticContraindicationsValueP",
			operationsForOCL.getOCLValue("VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ThrombolyticContraindicationsOperations.validateThrombolyticContraindicationsValueP(
					(ThrombolyticContraindications) objectToTest, diagnostician, map);
			}

		};

		validateThrombolyticContraindicationsValuePTestCase.doValidationTest();
}
