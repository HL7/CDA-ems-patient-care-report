...
public void testValidateHeightOfFallCodeP() {
			OperationsTestCase<HeightOfFall> validateHeightOfFallCodePTestCase = new OperationsTestCase<HeightOfFall>(
			"validateHeightOfFallCodeP",
			operationsForOCL.getOCLValue("VALIDATE_HEIGHT_OF_FALL_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeightOfFallOperations.validateHeightOfFallCodeP(
					(HeightOfFall) objectToTest, diagnostician, map);
			}

		};

		validateHeightOfFallCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateHeightOfFallCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_HEIGHT_OF_FALL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
            protected void setDependency(HeightOfFall target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.HeightOfFallCodeP", passToken);
            }
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeightOfFallOperations.validateHeightOfFallCode(
					(HeightOfFall) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateHeightOfFallValue() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeightOfFallOperations.validateHeightOfFallValue(
					(HeightOfFall) objectToTest, diagnostician, map);
			}
