...
public class ComplaintTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateComplaintTemplateId() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintTemplateId(
					(Complaint) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateComplaintMoodCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_COMPLAINT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintMoodCode(
					(Complaint) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateComplaintCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_COMPLAINT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintCodeP(
					(Complaint) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateComplaintCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_COMPLAINT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintCode(
					(Complaint) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateComplaintEffectiveTime() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintEffectiveTime(
					(Complaint) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateComplaintValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_COMPLAINT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintValue(
					(Complaint) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateComplaintTargetSiteCode() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ComplaintOperations.validateComplaintTargetSiteCode(
					(Complaint) objectToTest, diagnostician, map);
			}
