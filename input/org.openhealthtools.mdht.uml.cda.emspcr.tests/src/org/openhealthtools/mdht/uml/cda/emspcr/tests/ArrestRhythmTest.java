...
public class ArrestRhythmTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateArrestRhythmCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_ARREST_RHYTHM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ArrestRhythmOperations.validateArrestRhythmCode(
					(ArrestRhythm) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateArrestRhythmValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_ARREST_RHYTHM_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ArrestRhythmOperations.validateArrestRhythmValue(
					(ArrestRhythm) objectToTest, diagnostician, map);
			}
