...
public void testValidateInjuryCauseCategoryCodeP() {
			OperationsTestCase<InjuryCauseCategory> validateInjuryCauseCategoryCodePTestCase = new OperationsTestCase<InjuryCauseCategory>(
			"validateInjuryCauseCategoryCodeP",
			operationsForOCL.getOCLValue("VALIDATE_INJURY_CAUSE_CATEGORY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return InjuryCauseCategoryOperations.validateInjuryCauseCategoryCodeP(
					(InjuryCauseCategory) objectToTest, diagnostician, map);
			}

		};

		validateInjuryCauseCategoryCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateInjuryCauseCategoryCode() {
        ...
        @Override
            protected void setDependency(InjuryCauseCategory target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.InjuryCauseCategoryCodeP", passToken);
            }
...
public void testValidateInjuryCauseCategoryValueP() {
			OperationsTestCase<InjuryCauseCategory> validateInjuryCauseCategoryValuePTestCase = new OperationsTestCase<InjuryCauseCategory>(
			"validateInjuryCauseCategoryValueP",
			operationsForOCL.getOCLValue("VALIDATE_INJURY_CAUSE_CATEGORY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return InjuryCauseCategoryOperations.validateInjuryCauseCategoryValueP(
					(InjuryCauseCategory) objectToTest, diagnostician, map);
			}

		};

		validateInjuryCauseCategoryValuePTestCase.doValidationTest();
}
