...
public void testValidateHeartRateTemplateId() {
			OperationsTestCase<HeartRate> validateHeartRateTemplateIdTestCase = new OperationsTestCase<HeartRate>(
			"validateHeartRateTemplateId",
			operationsForOCL.getOCLValue("VALIDATE_HEART_RATE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeartRateOperations.validateHeartRateTemplateId(
					(HeartRate) objectToTest, diagnostician, map);
			}

		};

		validateHeartRateTemplateIdTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateHeartRateMoodCode() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeartRateOperations.validateHeartRateMoodCode(
					(HeartRate) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateHeartRateCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_HEART_RATE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeartRateOperations.validateHeartRateCodeP(
					(HeartRate) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateHeartRateCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_HEART_RATE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeartRateOperations.validateHeartRateCode(
					(HeartRate) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateHeartRateEffectiveTime() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeartRateOperations.validateHeartRateEffectiveTime(
					(HeartRate) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateHeartRateValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_HEART_RATE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HeartRateOperations.validateHeartRateValue(
					(HeartRate) objectToTest, diagnostician, map);
			}
