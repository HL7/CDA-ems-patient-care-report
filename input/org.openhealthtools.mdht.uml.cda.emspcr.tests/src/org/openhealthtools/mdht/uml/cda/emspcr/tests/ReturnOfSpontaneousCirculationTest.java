...
public void testValidateReturnOfSpontaneousCirculationCodeP() {
			OperationsTestCase<ReturnOfSpontaneousCirculation> validateReturnOfSpontaneousCirculationCodePTestCase = new OperationsTestCase<ReturnOfSpontaneousCirculation>(
			"validateReturnOfSpontaneousCirculationCodeP",
			operationsForOCL.getOCLValue("VALIDATE_RETURN_OF_SPONTANEOUS_CIRCULATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ReturnOfSpontaneousCirculationOperations.validateReturnOfSpontaneousCirculationCodeP(
					(ReturnOfSpontaneousCirculation) objectToTest, diagnostician, map);
			}

		};

		validateReturnOfSpontaneousCirculationCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateReturnOfSpontaneousCirculationCode() {
        ...
        @Override
            protected void setDependency(ReturnOfSpontaneousCirculation target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.ReturnOfSpontaneousCirculationCodeP", passToken);
            }
