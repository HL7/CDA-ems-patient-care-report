...
public class UnitOnSceneTimeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_UNIT_ON_SCENE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.41' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"UnitOnSceneTimeUnitOnSceneTimeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitOnSceneTimeUnitOnSceneTimeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitOnSceneTimeUnitOnSceneTimeCodeP","ERROR");
...
"value.code = '69473-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"UnitOnSceneTimeUnitOnSceneTimeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitOnSceneTimeUnitOnSceneTimeValue","ERROR");
