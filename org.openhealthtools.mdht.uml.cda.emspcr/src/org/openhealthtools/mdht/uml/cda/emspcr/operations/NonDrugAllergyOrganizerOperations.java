...
public class NonDrugAllergyOrganizerOperations extends OrganizerOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NON_DRUG_ALLERGY_ORGANIZER_EXISTENCE_OF_NON_DRUG_ALLERGY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.component->one(component : cda::Component4 | not component.observation.oclIsUndefined() and component.observation.oclIsKindOf(emspcr::ExistenceOfKnownNonDrugAllergy))";
    ...
    DatatypesUtil.increment(context,"NonDrugAllergyOrganizerNonDrugAllergyOrganizerExistenceOfNonDrugAllergy","ERROR");
    ...
    DatatypesUtil.increment(context,"NonDrugAllergyOrganizerNonDrugAllergyOrganizerNonDrugAllergy","INFO");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NON_DRUG_ALLERGY_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.49' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"NonDrugAllergyOrganizerNonDrugAllergyOrganizerTemplateId","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String GET_EXISTENCE_OF_NON_DRUG_ALLERGY__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(emspcr::ExistenceOfKnownNonDrugAllergy))->asSequence()->any(true).oclAsType(emspcr::ExistenceOfKnownNonDrugAllergy)";
	...
	public static  ExistenceOfKnownNonDrugAllergy getExistenceOfNonDrugAllergy(NonDrugAllergyOrganizer nonDrugAllergyOrganizer) {
		...
		return (ExistenceOfKnownNonDrugAllergy) query.evaluate(nonDrugAllergyOrganizer);
	}
