...
public class UnitBackInServiceTimeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_UNIT_BACK_IN_SERVICE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.45' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"UnitBackInServiceTimeUnitBackInServiceTimeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitBackInServiceTimeUnitBackInServiceTimeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitBackInServiceTimeUnitBackInServiceTimeCodeP","ERROR");
...
"value.code = '69477-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"UnitBackInServiceTimeUnitBackInServiceTimeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitBackInServiceTimeUnitBackInServiceTimeValue","ERROR");
