...
public class ResponseOnSceneOdometerReadingOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_RESPONSE_ON_SCENE_ODOMETER_READING_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.172' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ResponseOnSceneOdometerReadingResponseOnSceneOdometerReadingTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseOnSceneOdometerReadingResponseOnSceneOdometerReadingMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseOnSceneOdometerReadingResponseOnSceneOdometerReadingCodeP","ERROR");
...
"value.code = '67485-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ResponseOnSceneOdometerReadingResponseOnSceneOdometerReadingCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseOnSceneOdometerReadingResponseOnSceneOdometerReadingValue","ERROR");
