 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.MedicationNotAdministeredReasonObservation#validateMedicationNotAdministeredReasonObservationCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medication Not Administered Reason Observation Code P</em>}</li>
...
public class MedicationNotAdministeredReasonObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.105' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationMoodCode","ERROR");
	...
	/**
	 * The cached OCL expression body for the '{@link #validateMedicationNotAdministeredReasonObservationCodeP(MedicationNotAdministeredReasonObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medication Not Administered Reason Observation Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMedicationNotAdministeredReasonObservationCodeP(MedicationNotAdministeredReasonObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateMedicationNotAdministeredReasonObservationCodeP(MedicationNotAdministeredReasonObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medication Not Administered Reason Observation Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateMedicationNotAdministeredReasonObservationCodeP(MedicationNotAdministeredReasonObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static ThreadLocal<  Constraint> VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateMedicationNotAdministeredReasonObservationCodeP(MedicationNotAdministeredReasonObservation medicationNotAdministeredReasonObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationCodeP","ERROR");
    
  	  
  	  
		if (VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION);
			try {
				VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(medicationNotAdministeredReasonObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION__MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION_CODE_P,
						 EmspcrPlugin.INSTANCE.getString("MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationCodeP"),
						 new Object [] { medicationNotAdministeredReasonObservation }));
			}
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.emspcr.MedicationNotAdministeredReasonObservationCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.emspcr.MedicationNotAdministeredReasonObservationCodeP", passToken);
				}
				passToken.add(medicationNotAdministeredReasonObservation);
			}
...
"value.code = 'ASSERTION' and value.codeSystem = '2.16.840.1.113883.5.4')";
	...
	public static  boolean validateMedicationNotAdministeredReasonObservationCode(MedicationNotAdministeredReasonObservation medicationNotAdministeredReasonObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.MedicationNotAdministeredReasonObservationCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(medicationNotAdministeredReasonObservation)) {
    ...
    DatatypesUtil.increment(context,"MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA15185-4' or value.code = 'LA18921-9' or value.code = 'LA18922-7' or value.code = 'LA18925-0' or value.code = 'LA4216-3' or value.code = 'LA4389-8')))";
    ...
    DatatypesUtil.increment(context,"MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationNotAdministeredReasonObservationMedicationNotAdministeredReasonObservationValueP","ERROR");
