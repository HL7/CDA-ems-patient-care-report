 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSInjuryIncidentDescriptionSection#validateEMSInjuryIncidentDescriptionSectionCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Injury Incident Description Section Code P</em>}</li>
...
public class EMSInjuryIncidentDescriptionSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.17' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionTemplateId","ERROR");
...
"value.code = '67800-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionCode","ERROR");
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEMSInjuryIncidentDescriptionSectionCodeP(EMSInjuryIncidentDescriptionSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Injury Incident Description Section Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEMSInjuryIncidentDescriptionSectionCodeP(EMSInjuryIncidentDescriptionSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateEMSInjuryIncidentDescriptionSectionCodeP(EMSInjuryIncidentDescriptionSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Injury Incident Description Section Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEMSInjuryIncidentDescriptionSectionCodeP(EMSInjuryIncidentDescriptionSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static ThreadLocal<  Constraint> VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateEMSInjuryIncidentDescriptionSectionCodeP(EMSInjuryIncidentDescriptionSection emsInjuryIncidentDescriptionSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionCodeP","ERROR");
    
  	  
  	  
		if (VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.EMS_INJURY_INCIDENT_DESCRIPTION_SECTION);
			try {
				VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.EMS_INJURY_INCIDENT_DESCRIPTION_SECTION__EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_CODE_P,
						 EmspcrPlugin.INSTANCE.getString("EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionCodeP"),
						 new Object [] { emsInjuryIncidentDescriptionSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.title.oclIsUndefined() or self.title.isNullFlavorUndefined()) implies (not self.title.oclIsUndefined())";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionTitle","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionText","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionInjuryCauseCategory","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_INJURY_MECHANISM__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::InjuryMechanism) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionInjuryMechanism","WARNING");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionTraumaCenterCriteria","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_INJURY_RISK_FACTOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::TraumaTriageCriteriaSteps3and4) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionInjuryRiskFactor","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionVehicleImpactArea","INFO");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_PATIENT_LOCATION_IN_VEHICLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::PatientLocationInVehicle) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionPatientLocationInVehicle","INFO");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_VEHICLE_OCCUPANT_SAFETY_EQUIPMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::VehicleOccupantSafetyEquipment) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionVehicleOccupantSafetyEquipment","INFO");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionAirbagDeploymentStatus","INFO");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionHeightOfFall","INFO");
    ...
    DatatypesUtil.increment(context,"EMSInjuryIncidentDescriptionSectionEMSInjuryIncidentDescriptionSectionDisasterType","INFO");
	 ...
	 * @ordered
	 */
	protected static final String GET_TRAUMA_CENTER_CRITERIA__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(emspcr::TraumaTriageCriteriaSteps1and2))->asSequence()->any(true).oclAsType(emspcr::TraumaTriageCriteriaSteps1and2)";
	...
	public static  TraumaTriageCriteriaSteps1and2 getTraumaCenterCriteria(EMSInjuryIncidentDescriptionSection emsInjuryIncidentDescriptionSection) {
		...
		return (TraumaTriageCriteriaSteps1and2) query.evaluate(emsInjuryIncidentDescriptionSection);
	}
	 ...
	 * @ordered
	 */
	protected static final String GET_INJURY_RISK_FACTOR__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(emspcr::TraumaTriageCriteriaSteps3and4))->asSequence()->any(true).oclAsType(emspcr::TraumaTriageCriteriaSteps3and4)";
	...
	public static  TraumaTriageCriteriaSteps3and4 getInjuryRiskFactor(EMSInjuryIncidentDescriptionSection emsInjuryIncidentDescriptionSection) {
		...
		return (TraumaTriageCriteriaSteps3and4) query.evaluate(emsInjuryIncidentDescriptionSection);
	}
	...
	public static  DisasterType getDisasterType(EMSInjuryIncidentDescriptionSection emsInjuryIncidentDescriptionSection) {
		...
		if (GET_DISASTER_TYPE__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.EMS_INJURY_INCIDENT_DESCRIPTION_SECTION, EmspcrPackage.Literals.EMS_INJURY_INCIDENT_DESCRIPTION_SECTION.getEAllOperations().get(79));
			try {
