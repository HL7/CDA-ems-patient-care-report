...
public class AdverseEventTypeObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_ADVERSE_EVENT_TYPE_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.90' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"AdverseEventTypeObservationAdverseEventTypeObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"AdverseEventTypeObservationAdverseEventTypeObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"AdverseEventTypeObservationAdverseEventTypeObservationCodeP","ERROR");
...
"value.code = '67555-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"AdverseEventTypeObservationAdverseEventTypeObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA137-2' or value.code = 'LA17059-9' or value.code = 'LA17402-1' or value.code = 'LA17403-9' or value.code = 'LA17404-7' or value.code = 'LA17405-4' or value.code = 'LA17406-2' or value.code = 'LA17407-0' or value.code = 'LA17408-8' or value.code = 'LA17409-6' or value.code = 'LA17410-4' or value.code = 'LA17411-2' or value.code = 'LA17412-0' or value.code = 'LA17413-8' or value.code = 'LA17414-6')))";
    ...
    DatatypesUtil.increment(context,"AdverseEventTypeObservationAdverseEventTypeObservationValue","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_ADVERSE_EVENT_TYPE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (( not self.value->isEmpty())  and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";
    ...
    DatatypesUtil.increment(context,"AdverseEventTypeObservationAdverseEventTypeObservationValueP","ERROR");
