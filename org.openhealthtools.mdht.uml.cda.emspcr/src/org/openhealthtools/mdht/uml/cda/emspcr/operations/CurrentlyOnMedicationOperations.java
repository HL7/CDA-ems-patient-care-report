...
public class CurrentlyOnMedicationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CURRENTLY_ON_MEDICATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.75' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"CurrentlyOnMedicationCurrentlyOnMedicationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"CurrentlyOnMedicationCurrentlyOnMedicationMoodCode","ERROR");
...
"value.code = '67791-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"CurrentlyOnMedicationCurrentlyOnMedicationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CurrentlyOnMedicationCurrentlyOnMedicationValue","ERROR");
