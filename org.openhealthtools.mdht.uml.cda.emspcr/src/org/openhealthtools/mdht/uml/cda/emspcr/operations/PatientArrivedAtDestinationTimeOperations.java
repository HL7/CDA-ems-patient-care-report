...
public class PatientArrivedAtDestinationTimeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PATIENT_ARRIVED_AT_DESTINATION_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.44' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"PatientArrivedAtDestinationTimePatientArrivedAtDestinationTimeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientArrivedAtDestinationTimePatientArrivedAtDestinationTimeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientArrivedAtDestinationTimePatientArrivedAtDestinationTimeCodeP","ERROR");
...
"value.code = '69476-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"PatientArrivedAtDestinationTimePatientArrivedAtDestinationTimeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientArrivedAtDestinationTimePatientArrivedAtDestinationTimeValue","ERROR");
