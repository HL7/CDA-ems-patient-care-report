...
public class CandidatePatientRegistryTypeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CANDIDATE_PATIENT_REGISTRY_TYPE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.94' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"CandidatePatientRegistryTypeCandidatePatientRegistryTypeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"CandidatePatientRegistryTypeCandidatePatientRegistryTypeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CandidatePatientRegistryTypeCandidatePatientRegistryTypeCodeP","ERROR");
...
"value.code = '67553-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"CandidatePatientRegistryTypeCandidatePatientRegistryTypeCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17057-3' or value.code = 'LA17058-1' or value.code = 'LA17059-9' or value.code = 'LA17398-1' or value.code = 'LA17399-9' or value.code = 'LA17400-5' or value.code = 'LA17401-3' or value.code = 'LA7318-4' or value.code = 'LA9535-1' or value.code = 'LA9553-4')))";
    ...
    DatatypesUtil.increment(context,"CandidatePatientRegistryTypeCandidatePatientRegistryTypeValue","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CANDIDATE_PATIENT_REGISTRY_TYPE_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (( not self.value->isEmpty())  and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";
    ...
    DatatypesUtil.increment(context,"CandidatePatientRegistryTypeCandidatePatientRegistryTypeValueP","ERROR");
