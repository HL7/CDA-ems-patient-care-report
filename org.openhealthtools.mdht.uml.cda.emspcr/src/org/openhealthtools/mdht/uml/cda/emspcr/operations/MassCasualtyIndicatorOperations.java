...
public class MassCasualtyIndicatorOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MASS_CASUALTY_INDICATOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.87' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"MassCasualtyIndicatorMassCasualtyIndicatorTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"MassCasualtyIndicatorMassCasualtyIndicatorMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"MassCasualtyIndicatorMassCasualtyIndicatorCodeP","ERROR");
...
"value.code = '67490-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"MassCasualtyIndicatorMassCasualtyIndicatorCode","ERROR");
    ...
    DatatypesUtil.increment(context,"MassCasualtyIndicatorMassCasualtyIndicatorValue","ERROR");
