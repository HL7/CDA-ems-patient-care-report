...
public class NumberOfPatientsTransportedObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NUMBER_OF_PATIENTS_TRANSPORTED_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.31' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"NumberOfPatientsTransportedObservationNumberOfPatientsTransportedObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"NumberOfPatientsTransportedObservationNumberOfPatientsTransportedObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"NumberOfPatientsTransportedObservationNumberOfPatientsTransportedObservationCodeP","ERROR");
...
"value.code = '67547-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"NumberOfPatientsTransportedObservationNumberOfPatientsTransportedObservationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"NumberOfPatientsTransportedObservationNumberOfPatientsTransportedObservationValue","ERROR");
