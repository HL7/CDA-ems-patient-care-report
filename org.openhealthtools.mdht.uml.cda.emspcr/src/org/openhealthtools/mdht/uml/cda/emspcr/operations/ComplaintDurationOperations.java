...
public class ComplaintDurationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_COMPLAINT_DURATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.139' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ComplaintDurationComplaintDurationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ComplaintDurationComplaintDurationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ComplaintDurationComplaintDurationCodeP","ERROR");
...
"value.code = '67491-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ComplaintDurationComplaintDurationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ComplaintDurationComplaintDurationValue","ERROR");
