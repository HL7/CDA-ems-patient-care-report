 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.ThrombolyticContraindications#validateThrombolyticContraindicationsValueP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Thrombolytic Contraindications Value P</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThrombolyticContraindicationsOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.82' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ThrombolyticContraindicationsThrombolyticContraindicationsTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ThrombolyticContraindicationsThrombolyticContraindicationsMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ThrombolyticContraindicationsThrombolyticContraindicationsCodeP","ERROR");
...
"value.code = '67523-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ThrombolyticContraindicationsThrombolyticContraindicationsCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17114-2' or value.code = 'LA17115-9' or value.code = 'LA17116-7')))";
    ...
    DatatypesUtil.increment(context,"ThrombolyticContraindicationsThrombolyticContraindicationsValue","ERROR");
	...
	/**
	 * The cached OCL expression body for the '{@link #validateThrombolyticContraindicationsValueP(ThrombolyticContraindications, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Thrombolytic Contraindications Value P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateThrombolyticContraindicationsValueP(ThrombolyticContraindications, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() =  1 and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";

	/**
	 * The cached OCL invariant for the '{@link #validateThrombolyticContraindicationsValueP(ThrombolyticContraindications, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Thrombolytic Contraindications Value P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateThrombolyticContraindicationsValueP(ThrombolyticContraindications, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static ThreadLocal<  Constraint> VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateThrombolyticContraindicationsValueP(ThrombolyticContraindications thrombolyticContraindications, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"ThrombolyticContraindicationsThrombolyticContraindicationsValueP","ERROR");
    
  	  
  	  
		if (VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.THROMBOLYTIC_CONTRAINDICATIONS);
			try {
				VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(thrombolyticContraindications)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.THROMBOLYTIC_CONTRAINDICATIONS__THROMBOLYTIC_CONTRAINDICATIONS_VALUE_P,
						 EmspcrPlugin.INSTANCE.getString("ThrombolyticContraindicationsThrombolyticContraindicationsValueP"),
						 new Object [] { thrombolyticContraindications }));
			}
