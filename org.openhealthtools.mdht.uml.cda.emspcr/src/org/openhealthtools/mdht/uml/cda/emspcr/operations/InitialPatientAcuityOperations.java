...
public class InitialPatientAcuityOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_INITIAL_PATIENT_ACUITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.69' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"InitialPatientAcuityInitialPatientAcuityTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"InitialPatientAcuityInitialPatientAcuityMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"InitialPatientAcuityInitialPatientAcuityCodeP","ERROR");
...
"value.code = '67493-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"InitialPatientAcuityInitialPatientAcuityCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17696-8' or value.code = 'LA17695-0' or value.code = 'LA17694-3' or value.code = 'LA17697-6' or value.code = 'NewLA-4219011')))";
    ...
    DatatypesUtil.increment(context,"InitialPatientAcuityInitialPatientAcuityValue","ERROR");
    ...
    DatatypesUtil.increment(context,"InitialPatientAcuityInitialPatientAcuityValueP","ERROR");
