...
public class ProcedurePatientResponseObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURE_PATIENT_RESPONSE_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.135' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ProcedurePatientResponseObservationProcedurePatientResponseObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedurePatientResponseObservationProcedurePatientResponseObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedurePatientResponseObservationProcedurePatientResponseObservationCodeP","ERROR");
...
"value.code = '67546-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ProcedurePatientResponseObservationProcedurePatientResponseObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA65-8' or value.code = 'LA17181-1' or value.code = 'LA11011-6')))";
    ...
    DatatypesUtil.increment(context,"ProcedurePatientResponseObservationProcedurePatientResponseObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedurePatientResponseObservationProcedurePatientResponseObservationValueP","ERROR");
