...
public class EMSCurrentMedicationSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_CURRENT_MEDICATION_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.15' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionTemplateId","ERROR");
...
"value.code = '67844-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionCode","ERROR");
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEMSCurrentMedicationSectionCodeP(EMSCurrentMedicationSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Current Medication Section Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEMSCurrentMedicationSectionCodeP(EMSCurrentMedicationSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_CURRENT_MEDICATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateEMSCurrentMedicationSectionCodeP(EMSCurrentMedicationSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Current Medication Section Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEMSCurrentMedicationSectionCodeP(EMSCurrentMedicationSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static ThreadLocal<  Constraint> VALIDATE_EMS_CURRENT_MEDICATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateEMSCurrentMedicationSectionCodeP(
			EMSCurrentMedicationSection emsCurrentMedicationSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionCodeP","ERROR");
    
  	  
  	  
		if (VALIDATE_EMS_CURRENT_MEDICATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.EMS_CURRENT_MEDICATION_SECTION);
			try {
				VALIDATE_EMS_CURRENT_MEDICATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_EMS_CURRENT_MEDICATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_EMS_CURRENT_MEDICATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(emsCurrentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.EMS_CURRENT_MEDICATION_SECTION__EMS_CURRENT_MEDICATION_SECTION_CODE_P,
						 EmspcrPlugin.INSTANCE.getString("EMSCurrentMedicationSectionEMSCurrentMedicationSectionCodeP"),
						 new Object [] { emsCurrentMedicationSection }));
			}
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionTitle","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionText","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionCurrentlyOnMedication","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSCurrentMedicationSectionEMSCurrentMedicationSectionCurrentMedication","INFO");
	...
	public static CurrentlyOnMedication getCurrentlyOnMedication(
	...
	public static EList<CurrentMedication> getCurrentMedications(
			EMSCurrentMedicationSection emsCurrentMedicationSection) {
