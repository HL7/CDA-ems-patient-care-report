...
public class ProcedurePriorIndicatorOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURE_PRIOR_INDICATOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.131' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ProcedurePriorIndicatorProcedurePriorIndicatorTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedurePriorIndicatorProcedurePriorIndicatorMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedurePriorIndicatorProcedurePriorIndicatorCodeP","ERROR");
...
"value.code = '67542-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ProcedurePriorIndicatorProcedurePriorIndicatorCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedurePriorIndicatorProcedurePriorIndicatorValue","ERROR");
