...
public class CallTimeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CALL_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.38' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"CallTimeCallTimeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"CallTimeCallTimeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CallTimeCallTimeCodeP","ERROR");
...
"value.code = '69469-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"CallTimeCallTimeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CallTimeCallTimeValue","ERROR");
