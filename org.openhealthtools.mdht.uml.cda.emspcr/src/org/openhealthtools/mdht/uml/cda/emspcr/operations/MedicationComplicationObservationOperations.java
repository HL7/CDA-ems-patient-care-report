...
public class MedicationComplicationObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MEDICATION_COMPLICATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.107' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"MedicationComplicationObservationMedicationComplicationObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationComplicationObservationMedicationComplicationObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationComplicationObservationMedicationComplicationObservationCodeP","ERROR");
...
"value.code = '67541-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"MedicationComplicationObservationMedicationComplicationObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA137-2' or value.code = 'LA15098-9' or value.code = 'LA15099-7' or value.code = 'LA15424-7' or value.code = 'LA17059-9' or value.code = 'LA17392-4' or value.code = 'LA17393-2' or value.code = 'LA17394-0' or value.code = 'LA17396-5' or value.code = 'LA20641-9' or value.code = 'LA17713-1' or value.code = 'LA17714-9' or value.code = 'LA18266-9' or value.code = 'LA18267-7' or value.code = 'LA7418-2' or value.code = 'LA7434-9' or value.code = 'LA7443-0' or value.code = 'LA7444-8' or value.code = 'LA9540-1' or value.code = 'LA9541-9' or value.code = 'LA9548-4' or value.code = 'LA20642-7')))";
    ...
    DatatypesUtil.increment(context,"MedicationComplicationObservationMedicationComplicationObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"MedicationComplicationObservationMedicationComplicationObservationValueP","ERROR");
