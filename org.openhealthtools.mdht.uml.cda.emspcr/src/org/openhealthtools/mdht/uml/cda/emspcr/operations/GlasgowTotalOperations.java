...
public class GlasgowTotalOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_GLASGOW_TOTAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.158' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"GlasgowTotalGlasgowTotalTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"GlasgowTotalGlasgowTotalMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"GlasgowTotalGlasgowTotalCodeP","ERROR");
...
"value.code = '9269-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"GlasgowTotalGlasgowTotalCode","ERROR");
    ...
    DatatypesUtil.increment(context,"GlasgowTotalGlasgowTotalValue","ERROR");
