...
public class EmergencyMedicalDispatchObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMERGENCY_MEDICAL_DISPATCH_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.73' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"EmergencyMedicalDispatchObservationEmergencyMedicalDispatchObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"EmergencyMedicalDispatchObservationEmergencyMedicalDispatchObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"EmergencyMedicalDispatchObservationEmergencyMedicalDispatchObservationCodeP","ERROR");
...
"value.code = '67488-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"EmergencyMedicalDispatchObservationEmergencyMedicalDispatchObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17151-4' or value.code = 'LA17152-2' or value.code = 'LA17153-0' or value.code = 'LA32-8')))";
    ...
    DatatypesUtil.increment(context,"EmergencyMedicalDispatchObservationEmergencyMedicalDispatchObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"EmergencyMedicalDispatchObservationEmergencyMedicalDispatchObservationValueP","ERROR");
