...
public class ProtocolAgeCategoryOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROTOCOL_AGE_CATEGORY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.149' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ProtocolAgeCategoryProtocolAgeCategoryTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ProtocolAgeCategoryProtocolAgeCategoryMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProtocolAgeCategoryProtocolAgeCategoryCodeP","ERROR");
...
"value.code = '67538-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ProtocolAgeCategoryProtocolAgeCategoryCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17571-3' or value.code = 'LA17572-1' or value.code = 'LA17573-9')))";
    ...
    DatatypesUtil.increment(context,"ProtocolAgeCategoryProtocolAgeCategoryValue","ERROR");
    ...
    DatatypesUtil.increment(context,"ProtocolAgeCategoryProtocolAgeCategoryValueP","ERROR");
