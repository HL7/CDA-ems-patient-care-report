 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.PatientCareReport#validateUSRealmHeader2TemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate US Realm Header2 Template Id</em>}</li>
...
public class PatientCareReportOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateUSRealmHeader2TemplateId(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate US Realm Header2 Template Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateUSRealmHeader2TemplateId(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_US_REALM_HEADER2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.2' and id.extension = '2022-01-01')";

	/**
	 * The cached OCL invariant for the '{@link #validateUSRealmHeader2TemplateId(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate US Realm Header2 Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateUSRealmHeader2TemplateId(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateUSRealmHeader2TemplateId(PatientCareReport patientCareReport, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"PatientCareReportUSRealmHeader2TemplateId","ERROR");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_US_REALM_HEADER2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.PATIENT_CARE_REPORT__US_REALM_HEADER2_TEMPLATE_ID,
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportUSRealmHeader2TemplateId"),
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportClassCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportMoodCode","ERROR");
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CARE_REPORT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportId","ERROR");
    
  	  
  	  
		if (VALIDATE_PATIENT_CARE_REPORT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT);
			try {
				VALIDATE_PATIENT_CARE_REPORT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CARE_REPORT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CARE_REPORT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportId"),
						 new Object [] { patientCareReport }));
			}
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportCodeP","ERROR");
...
"value.code = '67796-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportCode","ERROR");
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CARE_REPORT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportTitle","ERROR");
    
  	  
  	  
		if (VALIDATE_PATIENT_CARE_REPORT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT);
			try {
				VALIDATE_PATIENT_CARE_REPORT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CARE_REPORT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CARE_REPORT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportTitle"),
						 new Object [] { patientCareReport }));
			}
...
"value.code = 'N' and value.codeSystem = '2.16.840.1.113883.5.25')";
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportConfidentialityCode","ERROR");
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CARE_REPORT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportVersionNumber","INFO");
    
  	  
  	  
		if (VALIDATE_PATIENT_CARE_REPORT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT);
			try {
				VALIDATE_PATIENT_CARE_REPORT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CARE_REPORT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CARE_REPORT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportVersionNumber"),
						 new Object [] { patientCareReport }));
			}
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportRecordTarget","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportCurrentMedication","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportCardiacArrestEvent","INFO");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportAdvanceDirectives","WARNING");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportAllergiesAndAdverseReactionsSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportPastMedicalHistorySection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportSocialHistorySection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportPhysicalAssessmentSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportMedicationsAdministeredSection","INFO");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportProceduresPerformedSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportPatientCareNarrativeSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportSceneSection","ERROR");
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CARE_REPORT_COMPONENT_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportComponentOf","ERROR");
    
  	  
  	  
		if (VALIDATE_PATIENT_CARE_REPORT_COMPONENT_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT);
			try {
				VALIDATE_PATIENT_CARE_REPORT_COMPONENT_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CARE_REPORT_COMPONENT_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CARE_REPORT_COMPONENT_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportComponentOf"),
						 new Object [] { patientCareReport }));
			}
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportDispatchSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportDispositionSection","INFO");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportPersonnelAdverseEventSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportProtocolSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportResponseSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportSituationSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportTimesSection","INFO");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportVitalSignsSection","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportAuthorParticipation","ERROR");
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CARE_REPORT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportCustodian","ERROR");
    
  	  
  	  
		if (VALIDATE_PATIENT_CARE_REPORT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT);
			try {
				VALIDATE_PATIENT_CARE_REPORT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CARE_REPORT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CARE_REPORT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportCustodian"),
						 new Object [] { patientCareReport }));
			}
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportDocumentationOf","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportRelatedDocument","INFO");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportParticipant","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportInjuryIncidentDescriptionSection","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PATIENT_CARE_REPORT_EMS_BILLING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSBillingSection))->size() >= 1";
    ...
    DatatypesUtil.increment(context,"PatientCareReportPatientCareReportEMSBillingSection","WARNING");
