...
public class ProcedureSuccessfulObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURE_SUCCESSFUL_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.133' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ProcedureSuccessfulObservationProcedureSuccessfulObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedureSuccessfulObservationProcedureSuccessfulObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedureSuccessfulObservationProcedureSuccessfulObservationCodeP","ERROR");
...
"value.code = '67544-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ProcedureSuccessfulObservationProcedureSuccessfulObservationCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ProcedureSuccessfulObservationProcedureSuccessfulObservationValue","ERROR");
