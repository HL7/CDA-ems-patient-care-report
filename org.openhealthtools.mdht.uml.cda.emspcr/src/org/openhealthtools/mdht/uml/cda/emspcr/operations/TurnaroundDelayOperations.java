...
public class TurnaroundDelayOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TURNAROUND_DELAY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.157' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"TurnaroundDelayTurnaroundDelayTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"TurnaroundDelayTurnaroundDelayMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"TurnaroundDelayTurnaroundDelayCodeP","ERROR");
...
"value.code = '67560-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"TurnaroundDelayTurnaroundDelayCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17059-9' or value.code = 'LA17587-9' or value.code = 'LA17590-3' or value.code = 'LA17592-9' or value.code = 'LA17593-7' or value.code = 'LA17594-5' or value.code = 'LA17598-6' or value.code = 'LA17599-4' or value.code = 'LA17600-0' or value.code = 'LA17601-8' or value.code = 'LA17602-6' or value.code = 'LA18081-2' or value.code = 'LA18270-1' or value.code = 'LA18271-9' or value.code = 'LA7497-6' or value.code = 'LA24425-3')))";
    ...
    DatatypesUtil.increment(context,"TurnaroundDelayTurnaroundDelayValue","ERROR");
    ...
    DatatypesUtil.increment(context,"TurnaroundDelayTurnaroundDelayValueP","ERROR");
