 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='PatientLocationInVehicleTemplateId PatientLocationInVehicleMoodCode PatientLocationInVehicleCode PatientLocationInVehicleCodeP PatientLocationInVehicleValue PatientLocationInVehicleValueP' templateId.root='2.16.840.1.1133883.17.3.10.1.55' templateId.extension='2022-01-01' moodCode='EVN' code.code='67498-6' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Location of patient in vehicle NEMSIS' constraints.validation.dependOn.PatientLocationInVehicleCode='PatientLocationInVehicleCodeP' value.codeSystem='2.16.840.1.113883.6.1' value.codeSystemName='LOINC'"
 * @generated
 */
public interface PatientLocationInVehicle extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId-&gt;exists(id : datatypes::II | id.root = \'2.16.840.1.1133883.17.3.10.1.55\' and id.extension = \'2022-01-01\')'"
	 * @generated
	 */
	 ...
	 * @generated
	 */
	boolean validatePatientLocationInVehicleCodeP(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validatePatientLocationInVehicleValueP(DiagnosticChain diagnostics, Map<Object, Object> context);
