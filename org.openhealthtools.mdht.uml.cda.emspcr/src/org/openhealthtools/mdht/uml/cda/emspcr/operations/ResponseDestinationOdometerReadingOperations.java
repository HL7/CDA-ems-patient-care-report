...
public class ResponseDestinationOdometerReadingOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_RESPONSE_DESTINATION_ODOMETER_READING_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.173' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"ResponseDestinationOdometerReadingResponseDestinationOdometerReadingTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseDestinationOdometerReadingResponseDestinationOdometerReadingMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseDestinationOdometerReadingResponseDestinationOdometerReadingCodeP","ERROR");
...
"value.code = '67486-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"ResponseDestinationOdometerReadingResponseDestinationOdometerReadingCode","ERROR");
    ...
    DatatypesUtil.increment(context,"ResponseDestinationOdometerReadingResponseDestinationOdometerReadingValue","ERROR");
