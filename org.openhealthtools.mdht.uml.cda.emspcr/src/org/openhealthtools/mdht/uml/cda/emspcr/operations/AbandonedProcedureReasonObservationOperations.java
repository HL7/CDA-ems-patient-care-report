...
public class AbandonedProcedureReasonObservationOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_ABANDONED_PROCEDURE_REASON_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.130' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"AbandonedProcedureReasonObservationAbandonedProcedureReasonObservationTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"AbandonedProcedureReasonObservationAbandonedProcedureReasonObservationMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"AbandonedProcedureReasonObservationAbandonedProcedureReasonObservationCodeP","ERROR");
...
"value.code = 'ASSERTION' and value.codeSystem = '2.16.840.1.113883.5.4')";
    ...
    DatatypesUtil.increment(context,"AbandonedProcedureReasonObservationAbandonedProcedureReasonObservationCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17078-9' or value.code = 'LA17079-7' or value.code = 'LA17080-5' or value.code = 'LA17081-3' or value.code = 'LA17082-1' or value.code = 'LA18204-0')))";
    ...
    DatatypesUtil.increment(context,"AbandonedProcedureReasonObservationAbandonedProcedureReasonObservationValue","ERROR");
    ...
    DatatypesUtil.increment(context,"AbandonedProcedureReasonObservationAbandonedProcedureReasonObservationValueP","ERROR");
