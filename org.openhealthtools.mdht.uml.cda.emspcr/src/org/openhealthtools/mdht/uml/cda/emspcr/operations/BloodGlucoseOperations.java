...
public class BloodGlucoseOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BLOOD_GLUCOSE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.166' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"BloodGlucoseBloodGlucoseTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"BloodGlucoseBloodGlucoseMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"BloodGlucoseBloodGlucoseCodeP","ERROR");
...
"value.code = '2339-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"BloodGlucoseBloodGlucoseCode","ERROR");
    ...
    DatatypesUtil.increment(context,"BloodGlucoseBloodGlucoseEffectiveTime","INFO");
    ...
    DatatypesUtil.increment(context,"BloodGlucoseBloodGlucoseValue","ERROR");
