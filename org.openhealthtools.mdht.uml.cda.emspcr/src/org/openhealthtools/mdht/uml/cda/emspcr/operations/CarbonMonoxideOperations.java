...
public class CarbonMonoxideOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CARBON_MONOXIDE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.167' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"CarbonMonoxideCarbonMonoxideTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"CarbonMonoxideCarbonMonoxideMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CarbonMonoxideCarbonMonoxideCodeP","ERROR");
...
"value.code = '20563-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"CarbonMonoxideCarbonMonoxideCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CarbonMonoxideCarbonMonoxideEffectiveTime","INFO");
    ...
    DatatypesUtil.increment(context,"CarbonMonoxideCarbonMonoxideValue","ERROR");
