...
public class UnitAtPatientTimeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_UNIT_AT_PATIENT_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.42' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"UnitAtPatientTimeUnitAtPatientTimeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitAtPatientTimeUnitAtPatientTimeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitAtPatientTimeUnitAtPatientTimeCodeP","ERROR");
...
"value.code = '69474-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"UnitAtPatientTimeUnitAtPatientTimeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"UnitAtPatientTimeUnitAtPatientTimeValue","ERROR");
