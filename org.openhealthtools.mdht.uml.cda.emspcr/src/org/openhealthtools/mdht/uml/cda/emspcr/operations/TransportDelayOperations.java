...
public class TransportDelayOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TRANSPORT_DELAY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.156' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"TransportDelayTransportDelayTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"TransportDelayTransportDelayMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"TransportDelayTransportDelayCodeP","ERROR");
...
"value.code = '67559-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"TransportDelayTransportDelayCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17059-9' or value.code = 'LA17585-3' or value.code = 'LA17586-1' or value.code = 'LA17587-9' or value.code = 'LA17588-7' or value.code = 'LA17589-5' or value.code = 'LA17590-3' or value.code = 'LA17591-1' or value.code = 'LA17592-9' or value.code = 'LA17593-7' or value.code = 'LA17594-5' or value.code = 'LA18081-2' or value.code = 'LA18270-1' or value.code = 'LA18271-9' or value.code = 'LA18301-4' or value.code = 'LA24424-6')))";
    ...
    DatatypesUtil.increment(context,"TransportDelayTransportDelayValue","ERROR");
    ...
    DatatypesUtil.increment(context,"TransportDelayTransportDelayValueP","ERROR");
