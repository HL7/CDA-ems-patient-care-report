...
public class PatientAgeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PATIENT_AGE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.81' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"PatientAgePatientAgeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientAgePatientAgeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientAgePatientAgeCodeP","ERROR");
...
"value.code = '30525-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"PatientAgePatientAgeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PatientAgePatientAgeValue","ERROR");
