...
public class EMSMedicationsAdministeredSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_MEDICATIONS_ADMINISTERED_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.18' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"EMSMedicationsAdministeredSectionEMSMedicationsAdministeredSectionTemplateId","ERROR");
...
"value.code = '67849-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"EMSMedicationsAdministeredSectionEMSMedicationsAdministeredSectionCode","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSMedicationsAdministeredSectionEMSMedicationsAdministeredSectionCodeP","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSMedicationsAdministeredSectionEMSMedicationsAdministeredSectionTitle","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSMedicationsAdministeredSectionEMSMedicationsAdministeredSectionText","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSMedicationsAdministeredSectionEMSMedicationsAdministeredSectionMedicationAdministered","INFO");
