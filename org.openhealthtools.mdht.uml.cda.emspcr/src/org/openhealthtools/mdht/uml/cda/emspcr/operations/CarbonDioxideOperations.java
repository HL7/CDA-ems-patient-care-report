...
public class CarbonDioxideOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CARBON_DIOXIDE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.168' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"CarbonDioxideCarbonDioxideTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"CarbonDioxideCarbonDioxideMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CarbonDioxideCarbonDioxideCodeP","ERROR");
...
"value.code = '19889-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"CarbonDioxideCarbonDioxideCode","ERROR");
    ...
    DatatypesUtil.increment(context,"CarbonDioxideCarbonDioxideEffectiveTime","INFO");
    ...
    DatatypesUtil.increment(context,"CarbonDioxideCarbonDioxideValue","ERROR");
