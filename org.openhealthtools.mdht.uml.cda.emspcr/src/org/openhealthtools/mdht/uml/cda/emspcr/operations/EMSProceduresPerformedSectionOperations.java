...
public class EMSProceduresPerformedSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_PROCEDURES_PERFORMED_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.21' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"EMSProceduresPerformedSectionEMSProceduresPerformedSectionTemplateId","ERROR");
...
"value.code = '29554-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"EMSProceduresPerformedSectionEMSProceduresPerformedSectionCode","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSProceduresPerformedSectionEMSProceduresPerformedSectionCodeP","ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_PROCEDURES_PERFORMED_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.title.oclIsUndefined() or self.title.isNullFlavorUndefined()) implies (not self.title.oclIsUndefined())";
    ...
    DatatypesUtil.increment(context,"EMSProceduresPerformedSectionEMSProceduresPerformedSectionTitle","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSProceduresPerformedSectionEMSProceduresPerformedSectionText","ERROR");
    ...
    DatatypesUtil.increment(context,"EMSProceduresPerformedSectionEMSProceduresPerformedSectionProcedureActivityProcedure1","INFO");
