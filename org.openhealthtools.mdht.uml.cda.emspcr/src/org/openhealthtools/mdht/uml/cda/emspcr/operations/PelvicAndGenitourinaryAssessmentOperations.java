 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.PelvicAndGenitourinaryAssessment#validatePelvicAndGenitourinaryAssessmentCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pelvic And Genitourinary Assessment Code P</em>}</li>
...
public class PelvicAndGenitourinaryAssessmentOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.118' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentMoodCode","ERROR");
	...
	/**
	 * The cached OCL expression body for the '{@link #validatePelvicAndGenitourinaryAssessmentCodeP(PelvicAndGenitourinaryAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pelvic And Genitourinary Assessment Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePelvicAndGenitourinaryAssessmentCodeP(PelvicAndGenitourinaryAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validatePelvicAndGenitourinaryAssessmentCodeP(PelvicAndGenitourinaryAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Pelvic And Genitourinary Assessment Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePelvicAndGenitourinaryAssessmentCodeP(PelvicAndGenitourinaryAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentCodeP","ERROR");
    
  	  
  	  
		if (VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PELVIC_AND_GENITOURINARY_ASSESSMENT);
			try {
				VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(pelvicAndGenitourinaryAssessment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.PELVIC_AND_GENITOURINARY_ASSESSMENT__PELVIC_AND_GENITOURINARY_ASSESSMENT_CODE_P,
						 EmspcrPlugin.INSTANCE.getString("PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentCodeP"),
						 new Object [] { pelvicAndGenitourinaryAssessment }));
			}
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.emspcr.PelvicAndGenitourinaryAssessmentCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.emspcr.PelvicAndGenitourinaryAssessmentCodeP", passToken);
				}
				passToken.add(pelvicAndGenitourinaryAssessment);
			}
...
"value.code = '67531-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validatePelvicAndGenitourinaryAssessmentCode(PelvicAndGenitourinaryAssessment pelvicAndGenitourinaryAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.PelvicAndGenitourinaryAssessmentCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(pelvicAndGenitourinaryAssessment)) {
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentEffectiveTime","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17208-2' or value.code = 'LA17209-0' or value.code = 'LA17213-2' or value.code = 'LA17214-0' or value.code = 'LA17212-4' or value.code = 'LA17248-8' or value.code = 'LA17249-6' or value.code = 'LA17250-4' or value.code = 'LA17251-2' or value.code = 'LA17252-0' or value.code = 'LA17253-8' or value.code = 'LA17254-6' or value.code = 'LA17255-3' or value.code = 'LA17709-9' or value.code = 'LA18220-6' or value.code = 'LA18221-4' or value.code = 'LA18222-2' or value.code = 'LA18223-0' or value.code = 'LA18224-8' or value.code = 'LA18225-5' or value.code = 'LA18226-3' or value.code = 'LA6626-1' or value.code = 'LA7410-9' or value.code = 'LA7452-1' or value.code = 'LA7460-4' or value.code = 'LA17229-8' or value.code = 'LA7423-2' or value.code = 'LA14123-6')))";
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentValue","ERROR");
    ...
    DatatypesUtil.increment(context,"PelvicAndGenitourinaryAssessmentPelvicAndGenitourinaryAssessmentValueP","ERROR");
