...
public class GlasgowMotorOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_GLASGOW_MOTOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.192' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"GlasgowMotorGlasgowMotorTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"GlasgowMotorGlasgowMotorMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"GlasgowMotorGlasgowMotorCodeP","ERROR");
...
"value.code = '9268-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"GlasgowMotorGlasgowMotorCode","ERROR");
    ...
    DatatypesUtil.increment(context,"GlasgowMotorGlasgowMotorValue","ERROR");
