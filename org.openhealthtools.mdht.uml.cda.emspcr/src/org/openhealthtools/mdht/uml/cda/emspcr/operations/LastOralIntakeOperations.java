...
public class LastOralIntakeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_LAST_ORAL_INTAKE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.80' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"LastOralIntakeLastOralIntakeTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"LastOralIntakeLastOralIntakeMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"LastOralIntakeLastOralIntakeCodeP","ERROR");
...
"value.code = '67517-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"LastOralIntakeLastOralIntakeCode","ERROR");
    ...
    DatatypesUtil.increment(context,"LastOralIntakeLastOralIntakeValue","ERROR");
