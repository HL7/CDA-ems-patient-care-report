...
public class PrimarySymptomOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PRIMARY_SYMPTOM_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.66' and id.extension = '2022-01-01')";
    ...
    DatatypesUtil.increment(context,"PrimarySymptomPrimarySymptomTemplateId","ERROR");
    ...
    DatatypesUtil.increment(context,"PrimarySymptomPrimarySymptomMoodCode","ERROR");
    ...
    DatatypesUtil.increment(context,"PrimarySymptomPrimarySymptomCodeP","ERROR");
...
"value.code = '67774-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
    ...
    DatatypesUtil.increment(context,"PrimarySymptomPrimarySymptomCode","ERROR");
...
"value.codeSystem = '2.16.840.1.113883.6.90'))";
    ...
    DatatypesUtil.increment(context,"PrimarySymptomPrimarySymptomValue","ERROR");
    ...
    DatatypesUtil.increment(context,"PrimarySymptomPrimarySymptomValueP","ERROR");
