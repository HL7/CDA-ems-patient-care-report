...
public class CallTimeTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateCallTimeTemplateId() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CallTimeOperations.validateCallTimeTemplateId(
					(CallTime) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateCallTimeMoodCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_CALL_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CallTimeOperations.validateCallTimeMoodCode(
					(CallTime) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateCallTimeCodeP() {
			...
			operationsForOCL.getOCLValue("VALIDATE_CALL_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CallTimeOperations.validateCallTimeCodeP(
					(CallTime) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateCallTimeCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_CALL_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CallTimeOperations.validateCallTimeCode(
					(CallTime) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateCallTimeValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_CALL_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CallTimeOperations.validateCallTimeValue(
					(CallTime) objectToTest, diagnostician, map);
			}
