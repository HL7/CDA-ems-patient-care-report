...
public void testValidateMedicationResponseObservationValueP() {
			OperationsTestCase<MedicationResponseObservation> validateMedicationResponseObservationValuePTestCase = new OperationsTestCase<MedicationResponseObservation>(
			"validateMedicationResponseObservationValueP",
			operationsForOCL.getOCLValue("VALIDATE_MEDICATION_RESPONSE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return MedicationResponseObservationOperations.validateMedicationResponseObservationValueP(
					(MedicationResponseObservation) objectToTest, diagnostician, map);
			}

		};

		validateMedicationResponseObservationValuePTestCase.doValidationTest();
}
