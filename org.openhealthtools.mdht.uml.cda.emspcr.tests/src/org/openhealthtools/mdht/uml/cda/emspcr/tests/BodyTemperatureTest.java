...
public void testValidateBodyTemperatureTemplateId() {
			OperationsTestCase<BodyTemperature> validateBodyTemperatureTemplateIdTestCase = new OperationsTestCase<BodyTemperature>(
			"validateBodyTemperatureTemplateId",
			operationsForOCL.getOCLValue("VALIDATE_BODY_TEMPERATURE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return BodyTemperatureOperations.validateBodyTemperatureTemplateId(
					(BodyTemperature) objectToTest, diagnostician, map);
			}

		};

		validateBodyTemperatureTemplateIdTestCase.doValidationTest();
}
