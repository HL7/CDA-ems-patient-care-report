...
public void testValidateTransportModeObservationTransportModeQualifierRelationship() {
			OperationsTestCase<TransportModeObservation> validateTransportModeObservationTransportModeQualifierRelationshipTestCase = new OperationsTestCase<TransportModeObservation>(
			"validateTransportModeObservationTransportModeQualifierRelationship",
			operationsForOCL.getOCLValue("VALIDATE_TRANSPORT_MODE_OBSERVATION_TRANSPORT_MODE_QUALIFIER_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return TransportModeObservationOperations.validateTransportModeObservationTransportModeQualifierRelationship(
					(TransportModeObservation) objectToTest, diagnostician, map);
			}

		};

		validateTransportModeObservationTransportModeQualifierRelationshipTestCase.doValidationTest();
}
