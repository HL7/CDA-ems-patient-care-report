...
public class GlasgowMotorTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateGlasgowMotorCodeP() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowMotorOperations.validateGlasgowMotorCodeP(
					(GlasgowMotor) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowMotorCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_MOTOR_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowMotorOperations.validateGlasgowMotorCode(
					(GlasgowMotor) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowMotorValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_MOTOR_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowMotorOperations.validateGlasgowMotorValue(
					(GlasgowMotor) objectToTest, diagnostician, map);
			}
