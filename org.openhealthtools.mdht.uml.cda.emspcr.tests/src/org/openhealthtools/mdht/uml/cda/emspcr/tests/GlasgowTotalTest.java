...
public class GlasgowTotalTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateGlasgowTotalCodeP() {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowTotalOperations.validateGlasgowTotalCodeP(
					(GlasgowTotal) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowTotalCode() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_TOTAL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
        ...
        @Override
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowTotalOperations.validateGlasgowTotalCode(
					(GlasgowTotal) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGlasgowTotalValue() {
			...
			operationsForOCL.getOCLValue("VALIDATE_GLASGOW_TOTAL_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return GlasgowTotalOperations.validateGlasgowTotalValue(
					(GlasgowTotal) objectToTest, diagnostician, map);
			}
