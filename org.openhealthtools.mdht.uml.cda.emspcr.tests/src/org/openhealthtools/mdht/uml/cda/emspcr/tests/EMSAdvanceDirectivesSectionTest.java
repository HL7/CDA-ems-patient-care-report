...
public void testValidateEMSAdvanceDirectivesSectionCodeP() {
			OperationsTestCase<EMSAdvanceDirectivesSection> validateEMSAdvanceDirectivesSectionCodePTestCase = new OperationsTestCase<EMSAdvanceDirectivesSection>(
			"validateEMSAdvanceDirectivesSectionCodeP",
			operationsForOCL.getOCLValue("VALIDATE_EMS_ADVANCE_DIRECTIVES_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EMSAdvanceDirectivesSectionOperations.validateEMSAdvanceDirectivesSectionCodeP(
					(EMSAdvanceDirectivesSection) objectToTest, diagnostician, map);
			}

		};

		validateEMSAdvanceDirectivesSectionCodePTestCase.doValidationTest();
}
...
public void testGetAdvancedDirectiveObservation() {


EMSAdvanceDirectivesSection target = objectFactory.create();
target.getAdvancedDirectiveObservation();
