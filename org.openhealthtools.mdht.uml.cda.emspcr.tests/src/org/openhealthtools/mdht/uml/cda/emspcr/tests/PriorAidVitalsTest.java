...
public void testValidatePriorAidVitalsCodeP() {
			OperationsTestCase<PriorAidVitals> validatePriorAidVitalsCodePTestCase = new OperationsTestCase<PriorAidVitals>(
			"validatePriorAidVitalsCodeP",
			operationsForOCL.getOCLValue("VALIDATE_PRIOR_AID_VITALS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PriorAidVitalsOperations.validatePriorAidVitalsCodeP(
					(PriorAidVitals) objectToTest, diagnostician, map);
			}

		};

		validatePriorAidVitalsCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidatePriorAidVitalsCode() {
        ...
        @Override
            protected void setDependency(PriorAidVitals target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.PriorAidVitalsCodeP", passToken);
            }
