...
public void testValidateResponseModeToSceneResponseModeQualifier() {
			OperationsTestCase<ResponseModeToScene> validateResponseModeToSceneResponseModeQualifierTestCase = new OperationsTestCase<ResponseModeToScene>(
			"validateResponseModeToSceneResponseModeQualifier",
			operationsForOCL.getOCLValue("VALIDATE_RESPONSE_MODE_TO_SCENE_RESPONSE_MODE_QUALIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ResponseModeToSceneOperations.validateResponseModeToSceneResponseModeQualifier(
					(ResponseModeToScene) objectToTest, diagnostician, map);
			}

		};

		validateResponseModeToSceneResponseModeQualifierTestCase.doValidationTest();
}
...
public void testGetResponseModeQualifier() {


ResponseModeToScene target = objectFactory.create();
target.getResponseModeQualifier();
