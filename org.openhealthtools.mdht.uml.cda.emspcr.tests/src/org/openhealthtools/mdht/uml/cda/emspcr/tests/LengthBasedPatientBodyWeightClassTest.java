...
public void testValidateLengthBasedPatientBodyWeightClassValueP() {
			OperationsTestCase<LengthBasedPatientBodyWeightClass> validateLengthBasedPatientBodyWeightClassValuePTestCase = new OperationsTestCase<LengthBasedPatientBodyWeightClass>(
			"validateLengthBasedPatientBodyWeightClassValueP",
			operationsForOCL.getOCLValue("VALIDATE_LENGTH_BASED_PATIENT_BODY_WEIGHT_CLASS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return LengthBasedPatientBodyWeightClassOperations.validateLengthBasedPatientBodyWeightClassValueP(
					(LengthBasedPatientBodyWeightClass) objectToTest, diagnostician, map);
			}

		};

		validateLengthBasedPatientBodyWeightClassValuePTestCase.doValidationTest();
}
