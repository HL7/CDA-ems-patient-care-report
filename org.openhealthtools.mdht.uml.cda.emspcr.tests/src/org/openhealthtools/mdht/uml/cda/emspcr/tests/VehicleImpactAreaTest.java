...
public void testValidateVehicleImpactAreaCodeP() {
			OperationsTestCase<VehicleImpactArea> validateVehicleImpactAreaCodePTestCase = new OperationsTestCase<VehicleImpactArea>(
			"validateVehicleImpactAreaCodeP",
			operationsForOCL.getOCLValue("VALIDATE_VEHICLE_IMPACT_AREA_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return VehicleImpactAreaOperations.validateVehicleImpactAreaCodeP(
					(VehicleImpactArea) objectToTest, diagnostician, map);
			}

		};

		validateVehicleImpactAreaCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateVehicleImpactAreaCode() {
        ...
        @Override
            protected void setDependency(VehicleImpactArea target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.VehicleImpactAreaCodeP", passToken);
            }
...
public void testValidateVehicleImpactAreaValueP() {
			OperationsTestCase<VehicleImpactArea> validateVehicleImpactAreaValuePTestCase = new OperationsTestCase<VehicleImpactArea>(
			"validateVehicleImpactAreaValueP",
			operationsForOCL.getOCLValue("VALIDATE_VEHICLE_IMPACT_AREA_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return VehicleImpactAreaOperations.validateVehicleImpactAreaValueP(
					(VehicleImpactArea) objectToTest, diagnostician, map);
			}

		};

		validateVehicleImpactAreaValuePTestCase.doValidationTest();
}
