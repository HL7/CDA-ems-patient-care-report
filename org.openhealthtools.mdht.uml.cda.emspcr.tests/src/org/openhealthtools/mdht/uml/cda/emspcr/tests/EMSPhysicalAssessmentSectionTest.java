...
public void testValidateEMSPhysicalAssessmentSectionBodyWeight() {
			OperationsTestCase<EMSPhysicalAssessmentSection> validateEMSPhysicalAssessmentSectionBodyWeightTestCase = new OperationsTestCase<EMSPhysicalAssessmentSection>(
			"validateEMSPhysicalAssessmentSectionBodyWeight",
			operationsForOCL.getOCLValue("VALIDATE_EMS_PHYSICAL_ASSESSMENT_SECTION_BODY_WEIGHT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EMSPhysicalAssessmentSectionOperations.validateEMSPhysicalAssessmentSectionBodyWeight(
					(EMSPhysicalAssessmentSection) objectToTest, diagnostician, map);
			}

		};

		validateEMSPhysicalAssessmentSectionBodyWeightTestCase.doValidationTest();
}
...
public void testValidateEMSPhysicalAssessmentSectionLengthBasedBodyWeight() {
			OperationsTestCase<EMSPhysicalAssessmentSection> validateEMSPhysicalAssessmentSectionLengthBasedBodyWeightTestCase = new OperationsTestCase<EMSPhysicalAssessmentSection>(
			"validateEMSPhysicalAssessmentSectionLengthBasedBodyWeight",
			operationsForOCL.getOCLValue("VALIDATE_EMS_PHYSICAL_ASSESSMENT_SECTION_LENGTH_BASED_BODY_WEIGHT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EMSPhysicalAssessmentSectionOperations.validateEMSPhysicalAssessmentSectionLengthBasedBodyWeight(
					(EMSPhysicalAssessmentSection) objectToTest, diagnostician, map);
			}

		};

		validateEMSPhysicalAssessmentSectionLengthBasedBodyWeightTestCase.doValidationTest();
}
...
public void testGetPhysicalAssessmentOrganizers() {


EMSPhysicalAssessmentSection target = objectFactory.create();
target.getPhysicalAssessmentOrganizers();
