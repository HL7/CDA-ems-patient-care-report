...
public void testValidateReasonProcedureNotAttemptedObservationCodeP() {
			OperationsTestCase<ReasonProcedureNotAttemptedObservation> validateReasonProcedureNotAttemptedObservationCodePTestCase = new OperationsTestCase<ReasonProcedureNotAttemptedObservation>(
			"validateReasonProcedureNotAttemptedObservationCodeP",
			operationsForOCL.getOCLValue("VALIDATE_REASON_PROCEDURE_NOT_ATTEMPTED_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ReasonProcedureNotAttemptedObservationOperations.validateReasonProcedureNotAttemptedObservationCodeP(
					(ReasonProcedureNotAttemptedObservation) objectToTest, diagnostician, map);
			}

		};

		validateReasonProcedureNotAttemptedObservationCodePTestCase.doValidationTest();
}
	...
	*/
	...
	public void testValidateReasonProcedureNotAttemptedObservationCode() {
        ...
        @Override
            protected void setDependency(ReasonProcedureNotAttemptedObservation target) {
                Collection<Object> passToken = new java.util.ArrayList<Object>(3);
                passToken.add(target);
                map.put("org.openhealthtools.mdht.uml.cda.emspcr.ReasonProcedureNotAttemptedObservationCodeP", passToken);
            }
