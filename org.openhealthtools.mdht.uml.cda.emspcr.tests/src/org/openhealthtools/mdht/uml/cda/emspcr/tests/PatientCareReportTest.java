...
public void testValidateUSRealmHeader2TemplateId() {
			OperationsTestCase<PatientCareReport> validateUSRealmHeader2TemplateIdTestCase = new OperationsTestCase<PatientCareReport>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PatientCareReportOperations.validateUSRealmHeader2TemplateId(
...
public void testValidatePatientCareReportPastMedicalHistorySection() {
			...
			protected void updateToPass(PatientCareReport target) {
				...
				EmspcrFactory.eINSTANCE.createPastMedicalHistorySection().init(); 
...
public void testValidatePatientCareReportSocialHistorySection() {
			...
			protected void updateToPass(PatientCareReport target) {
				...
				EmspcrFactory.eINSTANCE.createSocialHistorySection().init(); 
...
public void testValidatePatientCareReportPatientCareNarrativeSection() {
			OperationsTestCase<PatientCareReport> validatePatientCareReportPatientCareNarrativeSectionTestCase = new OperationsTestCase<PatientCareReport>(
			"validatePatientCareReportPatientCareNarrativeSection",
			...
			protected void updateToPass(PatientCareReport target) {
				...
				PatientCareNarrativeSection section =
				
				EmspcrFactory.eINSTANCE.createPatientCareNarrativeSection().init(); 
		...
		validatePatientCareReportPatientCareNarrativeSectionTestCase.doValidationTest();
}		
...
public void testGetPatientCareNarrativeSection() {
